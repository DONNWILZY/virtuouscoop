...
class SendMoneySuccess extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line("You requested us to send money to another user. Here below us your info:")
            ->line('Total Amount: '.$data->cur .$data->amount)
            ->line('Charge: '.$data->cur .$data->charge)
            ->line('Net Amount: '.$data->cur .$data->new_amount)
