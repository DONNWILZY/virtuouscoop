...
class UserInterestController extends Controller
{
    ...
    public function submit(Request $request){
        ...
        if ($amount < $minimum){
            ...
            session()->flash('message', "Your intended Investment is below the minimum investment. You can only invest a minimum of NGN".$minimum." in this plan. ");
        ...
        elseif ($amount > $maximum){
            ...
            session()->flash('message', "Your intended Investment is above the maximum investment. You can only invest a maximum of NGN".$maximum." in this plan.");
            Session::flash('type', 'error');
        ...
        elseif ($amount > $profile->deposit_balance ){
            ...
            session()->flash('message', "You want to invest NGN".$amount.". But You have only NGN".$profile->deposit_balance." in your deposit balance. So Deposit money first or try transfer your all money to deposit balance using fund transfer.");
            Session::flash('type', 'error');
    ...
    public function confirm(Request $request){
        ...
        session()->flash('message', 'You Have Successfully Invest NGN'.$request->amount.'You can monitor your investment progress from My Investment Yield Tab from the menu.');
