...
class UserWithdrawsController extends Controller
{
    ...
    public function postWithdraw(Request $request)
    {
        ...
        if ($request->gateway == 1000){
            ...
            session()->flash('message', 'Your fund Withdraw Amount $ '.$request->amount.' Has Been Sent. You will be credited once we verify your request');
        ...
        $new_amount = $request->amount - $charge;
            ...
            session()->flash('message', 'Your Fund Withdraw Of $ '.$new_amount.' Has Been Sent. Fund will be remitted to your account Once we verify your request ');
            Session::flash('type', 'success');
            Session::flash('title', 'Withdraw Requested');
