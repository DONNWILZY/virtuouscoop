...
class UserDepositsController extends Controller
{
    ...
    public function stripeConfirm(Request $request)
    {
        ...
        session()->flash('message', 'Cheers, Before Charging Gateway Fee Your Deposit Amount is NGN ' . $request->amount . '. You Deposited Amount of NGN ' . $new_amount . ' Has Been Successfully Added to Your Balance.');
    ...
    public function getPaypalStatus(Request $request)
    {
        ...
        if ($result->getState() == 'approved'){
            ...
            session()->flash('message', 'Cheers, Before Charging Gateway Fee Your Deposit Amount is NGN ' . $amount . '. After Charging Gateway Fee Your Total Deposit Amount NGN'.$new_amount.' Has Been Successfully Add to Your Balance.');
            Session::flash('type', 'success');
            Session::flash('title', 'Deposit Successful');
    ...
    public function paymentPreview(Request $request)
    {
        ...
        if ($settings->minimum_deposit > $request->amount) {
            ...
            session()->flash('message', 'You need at least  NGN ' . $settings->minimum_deposit . ' to deposit money. Please increase money first. ');
    ...
    public function offline(Request $request)
    {
        ...
        session()->flash('message', 'Your Deposited Amount of NGN ' . $new_amount . ' Has Been Successfully sent. Please wait while we verify your deposit ');
        Session::flash('type', 'success');
 ...
 public function offline2(Request $request)
    {
        ...
        session()->flash('message', 'Your Deposited Amount of NGN ' . $new_amount . ' Has Been Successfully Deposited Into Your Wallet.');
        Session::flash('type', 'success');
        Session::flash('title', 'Deposit Requested');
