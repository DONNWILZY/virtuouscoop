...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name','account', 'savings_balance','mobile','address','country','state','zip', 'email', 'password','admin','active','membership_id','membership_started','membership_expired','token','d_code','ban','note','username'
    ];
