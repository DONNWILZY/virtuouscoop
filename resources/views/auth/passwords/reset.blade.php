									...
									<div class="card-body p-6">
										...
										<div class="text-center card-title">Forgot password</div>
											<div class="input-icon form-group">
												...
												<input class="form-control" placeholder="Please enter your email" type="email"  name="email" value="{{ $email or old('email') }}" required>
											</div>
											<div class="input-icon form-group">
												<span class="input-icon-addon search-icon">
													<i class="zmdi zmdi-email"></i>
												</span>
												<input class="form-control" placeholder="Please enter new password" type="paasword"  name="password" required>
											</div>
											<div class="input-icon form-group">
												<span class="input-icon-addon search-icon">
													<i class="zmdi zmdi-email"></i>
