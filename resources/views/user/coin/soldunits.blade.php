...
@section('content')
  ...
  <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">Sold Coins</h4>
							<ol class="breadcrumb">
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="example" class="table table-striped table-bordered border-top-0 border-bottom-0" style="width:100%">
												...
												<tbody>
													@php $id=0;@endphp
                                @foreach($cryptocoins as $withdraw)
                                    @php $id++;@endphp
                            <tr>
                                <td class="text-center">{{$withdraw->name}}</td>
                                <td class="text-center">{{$withdraw->units}}</td>
                                <td class="text-center">{{$withdraw->balance}}</td>
