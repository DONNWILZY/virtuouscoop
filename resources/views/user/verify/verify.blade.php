                                ...
                                {{ csrf_field() }}
									...
									<div class="alert alert-avatar alert-success alert-dismissible">
									  <span class="avatar" style="background-image: url({{asset(Auth::user()->profile->avatar)}})"></span>
										Your Account Has Been Verified On Our System. You are now a verified member of {{config('app.name')}}
									</div>
									@endif
									...
									<div class="alert alert-avatar alert-info alert-dismissible">
									  <span class="avatar" style="background-image: url({{asset(Auth::user()->profile->avatar)}})"></span>
										You Have Uploaded A Verification ID On {{config('app.name')}}. Please Wait While We Verify Your Uploaded ID
									</div>
									@endif
									@if($count->undone == 0)
									<div class="alert alert-avatar alert-danger alert-dismissible">
									  <span class="avatar" style="background-image: url({{asset(Auth::user()->profile->avatar)}})"></span>
										Your Account Has Not Been Verified Yet on {{config('app.name')}}. Please Upload A Means Of Identification To Get Verified On {{config('app.name')}} and become a bonafide member of the platform
									</div>
									@endif
										...
										<div class="form-group">
                                            ...
                                            <option value="Identity Card">Identity Card</option>
                                             ...
                                             <option value="Drivers' Licence'">NEPA Bill</option>
                                             <option value="Drivers' Licence'">Statement of Account</option>
