...
@section('content')
	...
	<div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">Withdraw Fund</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{route('userDashboard')}}">Dashboard</a></li>
								<li class="breadcrumb-item active" aria-current="page">Withdraw Fund</li>
							</ol>
						</div>
						<div class="row row-deck">
								...
								<form action="{{route('userWithdraw.post')}}" class="card" method="post">
									...
									<div class="card-header">
										<h3 class="card-title">Available For Withdrawal: <b>{{config('app.currency_symbol')}} {{$user->profile->main_balance +0}}</h3></b>
