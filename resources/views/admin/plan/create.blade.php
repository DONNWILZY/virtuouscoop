  ...
  <link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
   <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">New Investment Plan</h4>
							<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-lg-12">
							<form action="{{route('adminInvest.post')}}" class="card" method="post" >
							{{csrf_field()}}
									<div class="card-header">
										<h3 class="card-title">New Investment Plan</h3>
									</div>
									<div class="card-body">
										<div class="row">
										...
										<button type="submit" class="btn btn-primary">Create Investment Plan</button>
									</div>
									</div>
