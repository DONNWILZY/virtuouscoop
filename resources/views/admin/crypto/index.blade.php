...
@section('title', 'Purchased Cryptos')
@section('content')
        <link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
		
  <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">All Purchased Cryptos</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Dashboard</a></li>
								<li class="breadcrumb-item active" aria-current="page">Purchased Cryptos</li>
							</ol>
						</div>
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">All Purchased Crypto</div>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											...
											<table id="example" class="table table-striped table-bordered border-top-0 border-bottom-0" style="width:100%">
												  ...
												  @php $id=0;@endphp
													...
													<tr>
														...
														<td class="text-center"><span class="badge badge-pill badge-success">Approved</span></a></td>
														 @else
														<td class="text-center"><span class="badge badge-pill badge-danger">Rejected</span></td>
														 @endif
											  ...
											  @endforeach
											  @else
											<h3 class="text-center">You Have Not Purchased Any Cryptocurrency Yet</h3>
											@endif											
												</tbody>
											</table>
										</div>
