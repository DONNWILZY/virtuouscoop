...
@section('title', 'Pending Gift Cards')
@section('content')
        <link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
		
  <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">Pending Gift Cards</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Dashboard</a></li>
								<li class="breadcrumb-item active" aria-current="page">Pending Gift Cards</li>
							</ol>
						</div>
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Pending Purchase</div>
									</div>
									<div class="card-body">
												...
												<tbody>
												  @php $id=0;@endphp
													...
													<tr>
														...
														<td class="text-center"><a href="{{route('admin.card.update', $withdraw->id)}}" ><span class="badge badge-pill badge-success">Approve</span></a></td>
														
														 
														 <td class="text-center"><a href="{{route('admin.card.fraud', $withdraw->id)}}" ><span class="badge badge-pill badge-danger">Reject</span></a></td>
														 @endif
											     	</tr>
												 
											  @endforeach
											  @else
											<h3 class="text-center">There Is No Unapproved Gift Card</h3>
											@endif											
												</tbody>
											</table>
										</div>
