...
@section('title', 'Sold Coins')
@section('content')
        <link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
		
  <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">Purchased Coin Units</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Dashboard</a></li>
								<li class="breadcrumb-item active" aria-current="page">Purchased Coin Units</li>
							</ol>
						</div>
							<div class="row">
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Purchased Coin Units</div>
									</div>
									<div class="card-body">
												...
												<thead>
												   @if(count($coin) > 0)
													<tr>
														...
														<th class="text-center">View Buyer</th>
												...
												<tbody>
												  @php $id=0;@endphp
													...
													<tr>
														...
														<td class="text-center"><a href="{{route('admin.user.show', $withdraw->user->id)}}" class="icon"><span class="badge badge-pill badge-primary">View Buyer</span></a></td>
