...
@section('content')
  ...
  <div class=" content-area">
						<div class="page-header">
							<h4 class="page-title">Users Loan</h4>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Dashboard</a></li>
								<li class="breadcrumb-item active" aria-current="page">Users Loan</li>
							</ol>
						</div>
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Users' Loan</div>
									</div>
									<div class="card-body">
												...
												<tbody>
												 @php $id=0;@endphp
													...
													<tr>
														...
														<td class="text-center"><a href="{{route('adminloanapprove', $plan->id)}}" class="icon"><i class="fa fa-check text-primary"></i></a></td>
														<td class="text-center"><a href="{{route('adminloanreject', $plan->id)}}" class="icon"><i class="fa fa-close text-danger"></i></a></td>
														
											     	</tr>
												 
											  @endforeach
											  @else
											<h3 class="text-center">No Pending Loan Request</h3>
											@endif											
												</tbody>
											</table>
										</div>
