...
@section('content')
 <link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
					  ...
					  <div class=" content-area">
						...
						<div class="row">
							<div class="col-lg-12">
							 <form class="card" action="{{route('admin.local.update',['id'=>$gateway->id])}}" method="post">
                                {{csrf_field()}}
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-sm-12 col-md-12">
												<div class="form-group">
													 @if($gateway->id == 4)
														<label  class="control-label" for="val1">Paystack Public Key</label>
														<input id="val1" name="val1" type="text" value="{{$gateway->val1}}" class="form-control">
													
													@endif
													@if($gateway->id == 5)
														<label  class="control-label" for="val1">Flutterwave Public Key</label>
