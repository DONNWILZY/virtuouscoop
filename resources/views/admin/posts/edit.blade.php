...
<link href="{{asset('assets\plugins\notify\css\jquery.growl.css')}}" rel="stylesheet" />
   <div class=" content-area">
						...
						<div class="row">
							<div class="col-lg-12">
							<form action="{{route('admin.posts.update',['id'=>$post->id])}}" class="card" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
										...
										<div class="row">
											...
											<div class="form-group">
													<label class="form-label">Notification Title</label>
													 <input id="title" name="title" type="text"  value="{{$post->title}}"  placeholder="Enter notification title" class="form-control">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
											...
											<div class="col-md-12">
												<div class="form-group mb-0">
													...
													<textarea name="body" rows="5" class="form-control" placeholder="Enter notification description">{{$post->content}}</textarea>
												</div>
											</div>
										</div>
